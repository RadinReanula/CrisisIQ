...
- **Auto-Triage** — Background process that runs on new pending requests, producing urgency scores, category labels, coordinator briefs, and volunteer skill matches.
